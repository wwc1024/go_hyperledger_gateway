...
func InitRouter(middlewares ...gin.HandlerFunc) *gin.Engine {
	...
	peerRouter.Use(
		...
		middleware.TranslationMiddleware())
	{
		controller.PeerRegister(peerRouter)
	}
	...
	channelRouter.Use(
		...
		middleware.TranslationMiddleware())
	{
		controller.ChannelRegister(channelRouter)
	}
	...
	// dhtdashRouter := router.Group("/service/dhtdashboard")
	// dashRouter.Use(
	// 	sessions.Sessions("mysession", store),
	// 	middleware.RecoveryMiddleware(),
	// 	middleware.RequestLog(),
	...
	// 	middleware.TranslationMiddleware())
	// {
	// 	controller.DhtDashboardRegister(dhtdashRouter)
	// }
